...
public class Runner {
    ...
    public static void closeDriver() {
        BasePage.cerrarNavegador(); // Llama al método estático 'cerrar' de la clase BasePage para cerrar el navegador después de que se hayan ejecutado todas las pruebas.
    }
}